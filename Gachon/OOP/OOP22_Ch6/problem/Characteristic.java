...
public class Characteristic {
    ...
    public Characteristic(String desc) {
        /** Write a constructor that sets the description of the 
            characteristic to a given string and sets the rating 
            to zero to indicate that it has not yet been determined. */
        description = desc;
        rating = 0;
    }
